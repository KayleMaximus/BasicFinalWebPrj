...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<c:url value='/CSS/Course/reset.css'/> ">
        <link rel="stylesheet" href="<c:url value='/CSS/Course/course1.css'/> ">
        <link rel="stylesheet" href="<c:url value='/CSS/Course/font.css'/> ">
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700&amp;family=Open+Sans:wght@400;600;700&amp;display=swap" as="style" onload="this.onload = null;this.rel = 'stylesheet'"> 
        ...
        <link rel="manifest" href="<c:url value='/images/favicon/manifest.json'/>">
